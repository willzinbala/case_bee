...
Desenvolvido por *Willian José Nogueira* como desafio técnico de Engenharia de Dados com foco em boas práticas em Python, Spark, Modelagem de Dados, APIs públicas e Relatórios para tomada de decisão.
